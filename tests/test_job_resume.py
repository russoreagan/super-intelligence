...
class TestGetResumable:
    ...
    def test_interrupted_no_plan_not_resumable(self, tmp_path, monkeypatch):
        store = self._store(tmp_path, monkeypatch)
        store.save(
            "job_noplan", "goal", [], [], False, done=False, plan_steps=[], stories_completed=0
        )
    ...
    async def test_resume_skips_completed_stories(self, tmp_path):
        ...
        prior = {
            ...
            "plan_steps": [
                {
                    "id": "US-001",
                    "description": "read pass 1",
                    "expected_tool": "read_file",
                    "acceptance_criteria": [],
                },
                {
                    "id": "US-002",
                    "description": "read pass 2",
                    "expected_tool": "read_file",
                    "acceptance_criteria": [],
                },
            ],
