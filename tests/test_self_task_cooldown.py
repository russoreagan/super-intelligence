...
def test_env_seeds_the_window(monkeypatch, tmp_path):
    import brain.settings as settings_mod
    from brain.settings import Settings

    # An explicit settings.json entry beats env, and other tests in the suite
    # call settings.save() (which writes every default to disk) — isolate.
