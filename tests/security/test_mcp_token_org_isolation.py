...
The wiring (org id threaded into the RPCs, GET org-filtered) is covered separately
by tests/test_api_mcp_tokens.py; this file is the data-level isolation proof.
"""
