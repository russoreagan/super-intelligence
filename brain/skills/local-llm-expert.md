...
description: Master local LLM inference, model selection, VRAM optimization, and local deployment using Ollama, llama.cpp, vLLM, and LM Studio. Expert in quantization formats (GGUF, EXL2) and local AI privacy. Use this skill whenever the user asks about running models locally, VRAM requirements, quantization, Ollama, llama.cpp, vLLM, LM Studio, open-weight models, offline AI, or privacy-first AI deployment — even if they don't use those exact terms.
category: data-ai
risk: safe
source: community
