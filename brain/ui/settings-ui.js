...
(function () {
  ...
  const TRAIT_DIALS = [
    ...
    { id: 'composure', label: 'Composure', sub: 'steadiness', glyph: 'level',
      map: [ { key: 'chem_baseline_GABA', dir: +1, span: 0.10 }, { key: 'chem_baseline_CORT', dir: -1, span: 0.06 }, { key: 'emotional_reactivity_scale', dir: -1, span: 0.30 }, { key: 'cort_threat_increment', dir: -1, span: 0.008 } ] },
    { id: 'drive', label: 'Drive', sub: 'ambition · reward', glyph: 'arrow',
      map: [ { key: 'chem_baseline_DA', dir: +1, span: 0.15 }, { key: 'plasticity_arousal_weight', dir: +1, span: 0.10 }, { key: 'sentiment_DA_weight', dir: +1, span: 0.06 } ] },
