...
from brain.dmn_dedup import (
    _FRAME_VERB_CLASSES,  # noqa: F401  (re-exported for external importers)
    _STOP_WORDS,  # noqa: F401  (re-exported for external importers)
    DMN_DEDUP_WINDOW,
    DMN_FRAME_REPEAT_MAX,
    DMN_OVERLAP_THRESHOLD,  # noqa: F401  (re-exported for external importers)
    DMN_PROMPT_PRIORS,
    DMN_RECENT_ANGLES,
    DMN_RECENT_FRAMES,
    DMN_RECENT_THOUGHTS,
